...
FOOD_COLOR = "#D90D10"
BG_COLOR = "#000000"
GAME_OVER_S_OPTIONS = ["loh", "lame ass", "sosi hui", "pussy", "muslim genocide"]
curse_end = random.choice(GAME_OVER_S_OPTIONS)
...
#переделатт на рандом номера СВЕРХУ В ФОРЕ
...
def game_over():
    ...
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2,
                       font=('consolas', 70), text=curse_end, fill="red", tag="game_over")
